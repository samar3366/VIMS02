...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-update_revaluation.php");
        }
    </script>
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="admin-upload_results.php">Exam Cell</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Update Revaluation Results</h4>

                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin/update_results.php" enctype="multipart/form-data">
