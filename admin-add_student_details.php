...
<head>
    ...
    <title>Admin Portal|Add Student Details</title>
    <!-- Bootstrap Core CSS -->
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-add_students.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">ADD STUDENT'S DETAILS</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-add_student_details.php">Manage</a></li>
                        <li class="breadcrumb-item"><a href="admin-add_student_details.php">Students</a></li>
                        <li class="breadcrumb-item active">Add Student's Details</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Upload Student's Details</h4>

                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin/add-student-details.php" enctype="multipart/form-data">
                                        <input type="file" name="excelfile">
                                        <button type="submit" class="btn btn-primary m-b-10 m-l-5">Upload Sheet</button>
                                    </form>
                                </div>
                ...
                <div class="card">
                    <div class="card-title">
                        <h4>Samle Excel Table Format</h4>
