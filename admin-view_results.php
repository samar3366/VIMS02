...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-view_results.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-view_results.php">View Details</a></li>
                        <li class="breadcrumb-item"><a href="admin-view_results.php">Exam Cell</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin-view_results.php" enctype="multipart/form-data">
