...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_ws.php");
        }
    </script>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Workshops Atteneded</h4>

                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_ws.php">
                                        <div class="form-group">
                                            <label>Name</label>
                                            <textarea class="form-control" name="wsName" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Venue</label>
                                            <textarea class="form-control" name="wsVenue" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Start Date</label>
                                            <input type="date" class="form-control" name="wsStart">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">End Date</label>
                                            <input type="date" class="form-control" name="wsEnd">
                                        </div>
                                        <div class="form-group">
                                            <label>Certified Or Not</label>
                                            <select class="form-control" name="wsCertificate">
								                <option>Select any:</option>
												<option value="Yes">Yes</option>
												<option value="No">No</option>
								            </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-rounded m-b-10 m-l-5">Update</button>
                                    </form>
                                </div>
                            </div>
                        </div>
