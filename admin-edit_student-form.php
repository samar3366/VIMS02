...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-edit_student-form.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Update Details</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-edit_student-form.php">Manage</a></li>
                        <li class="breadcrumb-item"><a href="admin-edit_student-form.php">Students</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form method="post" action="admin/edit_student.php">
                                        <div class="row">
                                            <?php
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label>NAME</label>
                                                    <textarea class="form-control" rows="3" name="name" placeholder='<?php echo $row["name"];?>' value = '<?php echo $row["name"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>BATCH</label>
                                                    <textarea class="form-control" rows="3" name="batch" placeholder='<?php echo $row["batch"];?>' value = '<?php echo $row["batch"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>BRANCH</label>
                                                    <textarea class="form-control" rows="3" name="branch" placeholder=<?php echo $row["branch"];?> value=<?php echo $row["branch"];?>></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>SECTION</label>
                                                    <textarea class="form-control" rows="3" name="section" placeholder=<?php echo $row["section"];?> value=<?php echo $row["section"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>NUMBER</label>
                                                    <textarea class="form-control" rows="3" name="number" placeholder=<?php echo $row["number"];?> value=<?php echo $row["number"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>MAIL</label>
                                                    <textarea class="form-control" rows="3" name="mail" placeholder=<?php echo $row["mail"];?> value= <?php echo $row["mail"];?>></textarea>
                                                </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "<a href='admin-edit_student-form.php?htno=",$row["htno"],"'>Edit</a>";?></td>
                                            </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
