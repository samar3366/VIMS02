...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-edit_student_pa-form.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Past Academic Details</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form method="post" action="admin/edit_student_pa.php">
                                        <div class="row">
                                            <?php
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="ssc_institute" placeholder='<?php echo $row["ssc_institute"];?>' value = '<?php echo $row["ssc_institute"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>SSC PERCENTAGE</label>
                                                    <textarea class="form-control" rows="3" name="ssc_percentage" placeholder='<?php echo $row["ssc_percentage"];?>' value = '<?php echo $row["ssc_percentage"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>INTER INSTITUTE</label>
                                                    <textarea class="form-control" rows="3" name="inter_institute" placeholder=<?php echo $row["inter_institute"];?> value=<?php echo $row["inter_institute"];?>></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>INTER PERCENTAGE</label>
                                                    <textarea class="form-control" rows="3" name="inter_percentage" placeholder=<?php echo $row["inter_percentage"];?> value=<?php echo $row["inter_percentage"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>EAMCET RANK</label>
                                                    <textarea class="form-control" rows="3" name="eamcet_rank" placeholder=<?php echo $row["eamcet_rank"];?> value=<?php echo $row["eamcet_rank"];?>></textarea>
                                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Students's Past Academics</h4>
                                <h6 class="card-subtitle">Consists of Full Name, Gender, Father's Name, Mother's Name, DOB, Mother Tongue, Aadhar No to Edit with reference to Hall Ticket Number.</h6>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "<a href='admin-edit_student_pa-form.php?htno=",$row["htno"],"'>Edit</a>";?></td>
                                            </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
