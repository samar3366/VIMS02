...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-edit_student.php");
        }
    </script>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Faculty</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="admin-add_faculty_details.php">Add Details</a></li>
                                <li> <a class="has-arrow" href="#" aria-expanded="false">Edit</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="admin-edit_faculty.php">Edit Faculty</a></li>
                                        <li><a href="admin-edit_faculty_personal_details.php">Edit Personal Details</a></li>
                                        <li><a href="admin-edit_faculty_contact_details.php">Edit Contact Details</a></li>
                                        <li><a href="admin-edit_faculty_past_academics.php">Edit Past Academics</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "<a href='admin/delete_student.php?htno=",$row["htno"],"'>Delete</a>";?></td>
                                            </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
