...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-view_leaves-ccl.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">VIEW COMPENSATORY CASUAL LEAVE(CCL) DETAILS</h3> </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                          <?php
                                          //get faculty dept
                                          $query=mysqli_query($connect,"select * from leavesccl where facJntuId='$facJntuId'");
                                          if($query){
                                              while($row=mysqli_fetch_array($query)){
                                                  ...
                                                  if($row['hod_status'] == 'PENDING'){
                                                    ...
                                                    $requestAt = 'DEAN';
                                                  }elseif ($row['principal_status'] == 'PENDING') {
                                                    $requestAt = 'PRINCIPAL';
                                                  }else{
                                                    $requestAt = 'REQUEST COMPLETED';
                                                  }

                                                  if($row['hod_status'] == 'REJECTED' || $row['dean_status'] == 'REJECTED' || $row['principal_status'] == 'REJECTED'){
                                                    $statusApp = 'REJECTED';
                                                  }elseif($row['principal_status'] == 'APPROVED'){
                                                    $statusApp = 'APPROVED';
                                                  }else{
                                                    $statusApp = 'PENDING';
                                                  }?>
                                                  <tr>
                                                      ...
                                                      <td><?php echo $requestAt;?></td>
                                                      <td><?php echo $statusApp;?></td>
