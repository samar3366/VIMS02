  ...
  if(isset($_POST['apply'])){
    ...
    $utilized = 0;
     ...
     $fileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
      ...
      if($fileType != "jpg" && $fileType != "png" && $fileType != "jpeg" && $fileType != "gif" && $fileType != "docx" && $fileType != "doc" && $fileType != "pdf" && $fileType != "pptx"  ) {
       $err3="Sorry, only JPG, JPEG, PNG , GIF , PDF , DOCX , DOC files are allowed.";
       $uploadOk = 0;
      }
      ...
      //
        ...
        // code...
        $err8 = "Cannot Apply For More than 7 days.";
      }elseif($year1 != $year2){
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-apply_leaves-mrl.php");
        }
    </script>
