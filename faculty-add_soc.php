...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_soc.php");
        }
    </script>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Add Society Membership</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_soc.php">
                                        <div class="form-group">
                                            <label>Society Name</label>
                                            <input type="text" class="form-control" name="socName">
                                        </div>
                                        <div class="form-group">
                                            <label>Society Id</label>
                                            <textarea class="form-control" name="socId" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Society Type</label>
                                            <select class="form-control" name="socType">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-rounded m-b-10 m-l-5">Add Society Membership</button>
                                    </form>
                                </div>
                            </div>
                        </div>
