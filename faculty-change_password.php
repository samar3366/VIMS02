...
if(isset($_POST['uploadpic'])){
   if(!empty($_FILES['propic']['tmp_name'])&&file_exists($_FILES['propic']['tmp_name'])){
      ...
      $query=mysqli_query($connect,"update facacademic set propic='$image' where facJntuId='$facJntuId'");
      if ($query) {
...
if(isset($_POST['update'])){
  ...
  $np=$_POST['np'];
  $cp=$_POST['cp'];
  $r=mysqli_query($connect,"select * from faculty_auth where facJntuId='$facJntuId'");
  ...
  if($op!=$dp){
    ...
    $r=mysqli_query($connect,"update faculty_auth set pass='$np' where facJntuId='$facJntuId'");
    if($r===TRUE){
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-change_password.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">WELCOME <?php echo $name;?></h3> </div>
