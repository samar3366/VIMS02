...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_rpro.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_rpro.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="proTeam" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Project Duration</label>
                                            <textarea class="form-control" name="proDuration" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Project Funding</label>
                                            <textarea class="form-control" name="proFunding" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Project Sanctioned</label>
                                            <textarea class="form-control" name="proSanctioned" rows="3" ></textarea>
                                        </div>
