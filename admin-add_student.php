...
<head>
    ...
    <title>Admin Portal|Add Students</title>
    <!-- Bootstrap Core CSS -->
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-add_student.php");
        }
    </script>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Upload Student's Information</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin/add-student.php" enctype="multipart/form-data">
                 ...
                 <div class="col-lg-6">
                     <div class="card">
                    <div class="card-title">
                        <h4>Add Student Individually</h4>
                    </div>
                         <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin/add_student_individual.php">
                                                <div class="form-group">
                                                    <label>STUDENT HTNO</label>
                                                    <input class="form-control" type="text" name="htno" required >
                                                </div>
                                                <div class="form-group">
