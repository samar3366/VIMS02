...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "hod-faculty.php");
        }
    </script>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Total Faculty Information</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php $facJntuId=$row["facJntuId"];echo "<a href='hod-faculty-profile.php?facJntuId=".$facJntuId."'>"; echo $facJntuId."</a>";?></td>
