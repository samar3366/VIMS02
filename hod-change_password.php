...
if(isset($_POST['update'])){
  ...
  $np=$_POST['np'];
  $cp=$_POST['cp'];
  $r=mysqli_query($connect,"select * from hods where hid='$hdept'");
  ...
  if($op!=$dp){
    ...
    $r=mysqli_query($connect,"update hods set pass='$np' where hid='$hdept'");
    if($r===TRUE){
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "hod-change_password.php");
        }
    </script>
