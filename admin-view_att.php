...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-view_att.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-view_att.php">View Details</a></li>
                        <li class="breadcrumb-item"><a href="admin-view_att.php">Attendance</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin-view_att.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Branch</label>
                                            <select class="form-control" name="attendance" title="select any:">
                                               <option></option>
								                <?php
                                ...
                                if ($dbnamequery->num_rows > 0) {
                                    ...
                                    while($row = $dbnamequery->fetch_assoc()) {
                                      $dbname = $row['database()'];
                                                ...
                                                $x="select table_name  from information_schema.tables where table_schema='$dbname' and table_name like '%attendance%' order by create_time limit 24";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="fspell" title="select any:">
                                                <option></option>
								                <option>All Spells</option>
                                                <option>1</option>
                                                <option>2</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tospell" title="select any:">
                                                <option></option>
								                <option>All Spells</option>
                                                <option>1</option>
                                                <option>2</option>
