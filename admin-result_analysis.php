...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-result_analysis.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Result Analysis</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-result_analysis.php">View Details</a></li>
                        <li class="breadcrumb-item"><a href="admin-result_analysis.php">Exam Cell</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin-result_analysis.php" enctype="multipart/form-data">
