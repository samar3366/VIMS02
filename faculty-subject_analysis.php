...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-subject_analysis.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Subject Analysis</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="faculty-subject_analysis.php">View Results</a></li>
                        <li class="breadcrumb-item"><a href="faculty-subject_analysis.php">Exam Cell</a></li>
                        <li class="breadcrumb-item active">Subject Analysis</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty-subject_analysis.php" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Analysis of Subjects</h4>
                                <h6 class="card-subtitle">Consists of No of Backlog Students in particular subject &amp; Total Pass percentage.</h6>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>SUBJECT NAME</th>
                                                <th>SUBJECT CODE</th>
                                                <th>NO OF STUDENT WITH BACKLOG</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                include('connection.php');
                                                $sql_htno = "SELECT DISTINCT subj_name,subj_code FROM $table_name WHERE year = '$year' and sem = '$sem' and branch = '$branch'";
                                                ...
                                                $subj = $row_htno["subj_name"];
                                                $sql_marks = "SELECT * FROM $table_name WHERE type = 0 and subj_name = '$subj'";
                                                ...
                                                if ($result_marks->num_rows > 0) {
                                                    ...
                                                    while($row_marks = $result_marks->fetch_assoc()) {
                                                        if($row_marks["type"] == 0 && $row_marks["credits"] == 0){
                                                            $htno = $row_marks["htno"];
                                                            $sql_supply = "SELECT * FROM $table_name WHERE type = '1' and credits > 0 and htno = '$htno' and subj_code = '$subj';";
                                                ...
                                                $sql = "SELECT count(*) as count from $table_name WHERE year = '$year' and sem = '$sem' and branch = '$branch' and subj_name = '$subj'";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row_htno["subj_code"];?></td>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if ($result_marks->num_rows > 0) {
                                                    ...
                                                    while($row_marks = $result_marks->fetch_assoc()) {
                                                        if($row_marks["type"] == 0 && $row_marks["grade_points"] == 0){
                                                            $htno = $row_marks["htno"];
                                                            $sql_supply = "SELECT * FROM $table_name WHERE type = '1' and grade_points > 0 and htno = '$htno' and subj_code = '$subj';";
                                                ...
                                                $sql = "SELECT count(*) as count from $table_name WHERE year = '$year' and sem = '$sem' and branch = '$branch' and subj_name = '$subj' and type = 0";
