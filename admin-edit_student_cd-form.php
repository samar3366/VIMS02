...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-edit_student_cd_form.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Details</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form method="post" action="admin/edit_student_cd.php">
                                        <div class="row">
                                            <?php
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="father_no" placeholder='<?php echo $row["father_no"];?>' value = '<?php echo $row["father_no"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>FATHER MAIL</label>
                                                    <textarea class="form-control" rows="3" name="father_mail" placeholder='<?php echo $row["father_mail"];?>' value = '<?php echo $row["father_mail"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>MOTHER NO</label>
                                                    <textarea class="form-control" rows="3" name="mother_no" placeholder=<?php echo $row["mother_no"];?> value=<?php echo $row["mother_no"];?>></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>MOTHER MAIL</label>
                                                    <textarea class="form-control" rows="3" name="mother_mail" placeholder=<?php echo $row["mother_mail"];?> value=<?php echo $row["mother_mail"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>ADDRESS</label>
                                                    <textarea class="form-control" rows="3" name="address" placeholder=<?php echo $row["address"];?> value=<?php echo $row["address"];?>></textarea>
                                                </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "<a href='admin-edit_student_cd-form.php?htno=",$row["htno"],"'>Edit</a>";?></td>
                                            </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
