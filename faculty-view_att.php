<?php
    ...
    $query="select facDept from faculty where facJntuId='$fid'";
    $result = $connect->query($query);
    $row = $result->fetch_assoc();
    $facDept=strtolower($row["facDept"]);
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-view_att.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="faculty-view_att.php">View Results</a></li>
                        <li class="breadcrumb-item"><a href="faculty-view_att.php">Attendance</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty-view_att.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Table</label>
                                            <select class="form-control" name="attendance">
                                                <option></option>
								                <?php           //get current database name
                                ...
                                if ($dbnamequery->num_rows > 0) {
                                    ...
                                    while($row = $dbnamequery->fetch_assoc()) {
                                      $dbname = $row['database()'];
                                                ...
                                                $x="select table_name from information_schema.tables where table_schema='$dbname' and table_name like '%attendance%' and table_name like '%$facDept%' order by create_time desc";
