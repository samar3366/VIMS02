...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-view_results.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">View Results</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="faculty-view_results.php">View Results</a></li>
                        <li class="breadcrumb-item"><a href="faculty-view_results.php">Exam Cell</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty-view_results.php" enctype="multipart/form-data">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php $htno=$row["htno"];echo "<a href='faculty-view_student-profile.php?htno=".$htno."'>"; echo $htno."</a>";?></td>
