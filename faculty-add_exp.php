...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_exp.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_exp.php">
                                        <div class="form-group">
                                            <label>Institution</label>
                                            <textarea class="form-control" name="expInst" rows="3" placeholder="ex : Vignan Institue of Technology & Science"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Designation</label>
                                            <select class="form-control" name="expDesig">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="expJoin">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Date of Relieving</label>
                                            <input type="date" class="form-control" name="expRel">
                                        </div>
