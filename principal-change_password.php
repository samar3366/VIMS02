...
if(isset($_POST['update'])){
  ...
  $np=$_POST['np'];
  $cp=$_POST['cp'];
  $r=mysqli_query($connect,"select * from principal where pid='$pid'");
  ...
  if($op!=$dp){
    ...
    $r=mysqli_query($connect,"update principal set pass='$np' where pid='$pid'");
    if($r===TRUE){
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "principal-change_password.php");
        }
    </script>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-wpforms"></i><span class="hide-menu">Leave</span></a>
                            <ul aria-expanded="false" class="collapse">
