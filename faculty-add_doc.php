...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_doc.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_doc.php">
                                        <div class="form-group">
                                            <label>University</label>
                                            <input type="text" class="form-control" name="docUniv" >
                                        </div>
                                        <div class="form-group">
                                            <label>Scholar Name</label>
                                            <textarea class="form-control" name="docSchName" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Thesis</label>
                                            <textarea class="form-control" name="docThesis" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Specialization</label>
                                            <textarea class="form-control" name="docSpec" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                                            <textarea class="form-control" name="docStatus" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Year</label>
                                            <textarea class="form-control" name="docYear" rows="3" ></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-rounded m-b-10 m-l-5">Add Doctorate</button>
                                    </form>
                                </div>
                            </div>
                        </div>
