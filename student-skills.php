...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "student-skills.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="student/add_skills.php">
                                        <div class="form-group">
                                            <label>Skill</label>
                                            <input type="text" class="form-control" name="skill" placeholder="eg..,Core Java">
                                        </div>
                                        <div class="form-group">
                                            <label>Skill Domain</label>
                                            <textarea class="form-control" name="skill_domain" rows="3" placeholder="eg.,Java..."></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="desig" rows="3" placeholder="eg.,Java Developer.."></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary btn-rounded m-b-10 m-l-5">Add Skill</button>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge badge-primary"><?php echo $row["skill_level"];?></span></td>
