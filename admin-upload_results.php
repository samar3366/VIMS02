...
if(isset($_POST['submit'])){
  if($_POST['branch']!=""&&$_POST['batch']!=""&&$_POST['year']!=""&&$_POST['sem']!=""&&$_POST['type']!=""){
    ...
    if($bat!="Select any:"&&$branch!="Select any:"&&$year!="Select any:"&&$sem!="Select any:"&&$type!="Select any:"){
      ...
      if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
      {
          ...
          if($res1)
          {
              $msg1="Uploaded Results Successfully";
              //header("location:  admin-upload_results.php");
          }
          else
          {
              $msg2="Failed to Upload Results";
              //header("location: admin-upload_results.php");
          }
    ...
    }else $err2="Please select all the fields";
  }else $err2="Please fill all the fields";
}
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-upload_results.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Upload Results</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-upload_results.php">Manage</a></li>
      e                  <li class="breadcrumb-item"><a href="admin-upload_results.php">Exam Cell</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-title">
                                <h4>Add Results</h4><br>
                                <span>
                                  <label class="text-danger">
                                  <?php echo $err1;echo $err2;echo $msg2;  ?>
                                  </label>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
                                        ...
                                        <button name="submit" type="submit" class="btn btn-primary btn-rounded m-b-10 m-l-5">Add Results</button>
                                    </form>
                                </div>
                            </div>
