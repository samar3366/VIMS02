...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-edit_pd.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form method="post" action="faculty/edit_pd.php">
                                        <div class="row">
                                            <?php
                                                //include('connection.php');
                                                //$htno = $_GET['htno'];
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="facAicteId" placeholder='<?php echo $row["facAicteId"];?>' value = '<?php echo $row["facAicteId"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>AADHAR NO</label>
                                                    <textarea class="form-control" rows="3" name="facAadhar" placeholder='<?php echo $row["facAadhar"];?>' value = '<?php echo $row["facAadhar"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>PAN NO</label>
                                                    <textarea class="form-control" rows="3" name="facPan" placeholder='<?php echo $row["facPan"];?>' value=<?php echo $row["facPan"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>PASSPORT</label>
                                                    <textarea class="form-control" rows="3" name="facPassport" placeholder='<?php echo $row["facPassport"];?>' value=<?php echo $row["facPassport"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>VOTER ID</label>
                                                    <textarea class="form-control" rows="3" name="facVoter" placeholder='<?php echo $row["facVoter"];?>' value = <?php echo $row["facVoter"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>MOBILE NUMBER</label>
                                                    <textarea class="form-control" rows="3" name="facMobile" placeholder='<?php echo $row["facMobile"];?>' value = <?php echo $row["facMobile"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>MAIL ID</label>
                                                    <textarea class="form-control" rows="3" name="facEmail" placeholder='<?php echo $row["facEmail"];?>' value = <?php echo $row["facEmail"];?>></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>TEMPORARY ADDRESS</label>
                                                    <textarea class="form-control" rows="3" name="facTempAdd" placeholder='<?php echo $row["facTempAdd"];?>' value = <?php echo $row["facTempAdd"];?>></textarea>
                                                </div><div class="form-group">
                                                    <label>PERMENANT ADDRESS</label>
                                                    <textarea class="form-control" rows="3" name="facPerAdd" placeholder='<?php echo $row["facPerAdd"];?>' value = <?php echo $row["facPerAdd"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Date of Birth</label>
                                                    <input type="date" class="form-control" name="facDob">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Date of Joining</label>
                                                    <input type="date" class="form-control" name="facDoj">
                                                </div>
                                                <div class="form-group has-success">
                                                    <label class="control-label">Gender</label>
                                                    <select class="form-control custom-select" name="facGen">
                                                        <option value=""><?php echo $row["facGen"];?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control custom-select" data-placeholder="" tabindex="1" name="facBg">
                                                        <option value=""><?php echo $row["facBg"];?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control custom-select" data-placeholder="" tabindex="1" name="facMartial">
                                                        <option value=""><?php echo $row["facMartial"];?></option>
