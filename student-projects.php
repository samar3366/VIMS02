...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "student_projects.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="student/add_projects.php">
                                        <div class="form-group">
                                            <label>Name of Project</label>
                                            <input type="text" class="form-control" name="name" placeholder="eg Motio Imitation..,">
                                        </div>
                                        <div class="form-group">
                                            <label>Team(seperate by comma)</label>
                                            <textarea class="form-control" name="team" rows="3" placeholder="eg.,Tom,Jhon,Gideon..."></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Guide</label>
                                            <textarea class="form-control" name="guide" rows="3" placeholder="eg.,Rob Prachvel..."></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="description" rows="3" placeholder="eg.,hi there!!!!!.."></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Domain</label>
                                            <textarea class="form-control" name="domain" rows="3" placeholder="eg.,AI,Deep Learning.."></textarea>
                                        </div>
