...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-view_leaves.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"><?php echo $year;?> Leaves Details</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="faculty-result_analysis.php">View Results</a></li>
                        <li class="breadcrumb-item"><a href="faculty-result_analysis.php">Exam Cell</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#summary" role="tab">Summary</a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#list" role="tab">List of leaves</a> </li>
                            ...
                            <?php
                                       ...
                                       include('connection.php');
                                        $fid = $_SESSION["fid"];
                                        $sql = "SELECT * FROM faculty WHERE facJntuId='$fid';";
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo "Casual Leave(Jan-June)";?></td>
                                                                    <td><?php echo "6";?></td>
                                                                    <td><?php echo $casual1;?></td>
                                                                    <td><?php echo 6-$casual1;?></td>
                                                                </tr>

                                                                <tr>
                                                                    <td><?php echo "Casual Leave(July-Dec)";?></td>
                                                                    <td><?php echo "6";?></td>
                                                                    <td><?php echo $casual2;?></td>
                                                                    <td><?php echo 6-$casual2;?></td>
                                                                </tr>

                                                                <tr>
                                                                    <td><?php echo "Compensation casual leave";?></td>
                                                                    <td><?php echo $treqccl;?></td>
                                                                    <td><?php echo $appccl;?></td>
                                                                    <td><?php echo $treqccl-$appccl;?></td>
                                                                </tr>

                                                                <tr>
                                                                    <td><?php echo "Academic Leave";?></td>
                                                                    <td><?php echo "15";?></td>
                                                                    <td><?php echo $academics;?></td>
                                                                    <td><?php echo 15-$academics;?></td>
                                                                </tr>

                                                                <tr>
                                                                    <td><?php echo "Medical Leave";?></td>
                                                                    <td><?php echo "10";?></td>
                                                                    <td><?php echo $medical;?></td>
                                                                    <td><?php echo 10-$medical;?></td>
                                                                </tr>
                                ...
                                <div class="tab-pane" id="list" role="tabpanel">
                                    ...
                                    include('connection.php');
                                        $fid = $_SESSION["fid"];
                                        $sql = "SELECT * FROM facLeave WHERE facJntuId='$fid' AND YEAR(fdate)=$year";
                                        ...
                                        echo "<td>" . $row['description'] . "</td>";
                                            ...
                                            {
                                        ?>
                                         <td><span class="badge badge-info"><?php echo "Applied"; ?></span></td>
                                        <?php
                                            }
                                            else if($st=='Rejected'){
                                                ?>
