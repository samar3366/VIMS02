...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "hod-view_att.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="hod-view_att.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Table</label>
                                            <select class="form-control" name="attendance">
                                                <option></option>
								                <?php
                                                $x="select table_name from information_schema.tables where table_schema='vims02' and table_name like '%attendance%' and table_name like '%$hdept%' order by create_time desc";
