...
$sql=mysqli_query($connect,"select count(leave_id) as countCL from leavescl where hod_status='PENDING' ");
if($sql){
...
$sql=mysqli_query($connect,"select count(leave_id) as countAL from leavesal where hod_status='PENDING' ");
if($sql){
    while($row=mysqli_fetch_array($sql)){
        $countAL=$row['countAL'];
    }
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "hod-leaves-summary.php");
        }
    </script>
                              ...
                              <div class="table-responsive">
                                  <table class="table">
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>Casual Leaves</td>
                                          <td><?php echo $countCL ?></td>
                                        </tr>
                                        <tr>
                                          <td>Compensatory Casual Leaves</td>
                                          <td><?php echo $countCCL ?></td>
                                        </tr>
                                        <tr>
                                          <td>Medical Leaves</td>
                                          <td><?php echo $countML ?></td>
                                        </tr>
                                        <tr>
                                          <td>Academic Leaves</td>
                                          <td><?php echo $countAL ?></td>
                                        </tr>
                                        <tr>
                                          <td>Extraordinary Leaves</td>
                                          <td><?php echo $countEOL ?></td>
                                        </tr>
                                        <tr>
                                          <td>Maternity Leaves</td>
                                          <td><?php echo $countMTL ?></td>
                                        </tr>
                                        <tr>
                                          <td>On-Duty Leaves</td>
                                          <td><?php echo $countOD ?></td>
                                        </tr>
                                        <tr>
                                          <td>Marriage Leaves</td>
                                          <td><?php echo $countMRL ?></td>
                                        </tr>
