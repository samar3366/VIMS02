...
<head>
    ...
    <title>Admin Portal | Subject Analysis</title>
    <!-- Bootstrap Core CSS -->
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-subject_analysis.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-subject_analysis.php">View Details</a></li>
                        <li class="breadcrumb-item"><a href="admin-subject_analysis.php">Exam Cell</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="admin-subject_analysis.php" enctype="multipart/form-data">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                include('connection.php');
                                                $sql_htno = "SELECT DISTINCT subj_name,subj_code FROM 15_results WHERE year = '$year' and sem = '$sem' and branch = '$branch' and batch = '$batch'";
                                                ...
                                                $sql_marks = "SELECT * FROM 15_results WHERE type = 0 and subj_name = '$subj'";
                                                ...
                                                $sql = "SELECT count(*) as count from 15_results WHERE year = '$year' and sem = '$sem' and branch = '$branch' and subj_name = '$subj'";
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                include('connection.php');
                                                $sql_htno = "SELECT DISTINCT subj_name,subj_code FROM 16_results WHERE year = '$year' and sem = '$sem' and branch = '$branch' and  batch = '$batch'";
                                                ...
                                                $subj = $row_htno["subj_name"];
                                                $sql_marks = "SELECT * FROM 16_results WHERE type = 0 and subj_name = '$subj'";
