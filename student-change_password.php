...
if(isset($_POST['update'])){
  ...
  $np=$_POST['np'];
  $cp=$_POST['cp'];
  $r=mysqli_query($connect,"select * from student_auth where htno='$htno'");
  ...
  if($op!=$dp){
    ...
    $r=mysqli_query($connect,"update student_auth set pass='$np' where htno='$htno'");
    if($r===TRUE){
...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "student-change_password.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="student-certificates.php">Dashboard</a></li>
