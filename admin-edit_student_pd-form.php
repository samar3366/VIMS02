...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-edit_student_pd-form.php");
        }
    </script>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-elements">
                                    <form method="post" action="admin/edit_student_pd.php">
                                        <div class="row">
                                            <?php
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>HTNO</label>
                                                    <input class="form-control" type="text" name="htno" value=<?php echo $row["htno"];?>>
                                                </div>
                                                <div class="form-group">
                                                    <label>FULL NAME</label>
                                                    <textarea class="form-control" rows="3" name="full_name" placeholder='<?php echo $row["full_name"];?>' value = '<?php echo $row["full_name"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>GENDER</label>
                                                    <textarea class="form-control" rows="3" name="gender" placeholder='<?php echo $row["gender"];?>' value = '<?php echo $row["gender"];?>'></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>FATHER NAME</label>
                                                    <textarea class="form-control" rows="3" name="father_name" placeholder=<?php echo $row["father_name"];?> value=<?php echo $row["father_name"];?>></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>MOTHER NAME</label>
                                                    <textarea class="form-control" rows="3" name="mother_name" placeholder=<?php echo $row["mother_name"];?> value=<?php echo $row["mother_name"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>DOB</label>
                                                    <textarea class="form-control" rows="3" name="dob" placeholder=<?php echo $row["dob"];?> value=<?php echo $row["dob"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>MOTHER TONGUE</label>
                                                    <textarea class="form-control" rows="3" name="mother_tongue" placeholder=<?php echo $row["mother_tongue"];?> value= <?php echo $row["mother_tongue"];?>></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>AADHAR NO</label>
                                                    <textarea class="form-control" rows="3" name="aadhar_no" placeholder=<?php echo $row["aadhar_no"];?> value= <?php echo $row["aadhar_no"];?>></textarea>
                                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Students's Information</h4>
                                <h6 class="card-subtitle">Consists of Name, batch, Branch, Section, Number, Mail to Edit with reference to Hall Ticket Number.</h6>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo "<a href='admin-edit_student_pd-form.php?htno=",$row["htno"],"'>Edit</a>";?></td>
                                            </tr>
                                            <?php }}?>
                                        </tbody>
                                    </table>
