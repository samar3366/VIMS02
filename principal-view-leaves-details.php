...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "principal-view_leaves.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">WELCOME Principal</h3> </div>
                          ...
                          <div class="card-body">
                              <div class="basic-form">
                                  <form action="principal/approve2.php" method="post">
                                      ...
                                      <button type="submit" class="btn btn-info" name="forward">Approve</button>
