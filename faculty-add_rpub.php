...
<head>
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "faculty-add_rpub.php");
        }
    </script>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="faculty/add_rpub.php">
                                        ...
                                        <div class="form-group">
                                            <label>Journal</label>
                                            <textarea class="form-control" name="resJournal" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Volume</label>
                                            <textarea class="form-control" name="resVol" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Issue No</label>
                                            <textarea class="form-control" name="resIssue" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Issn</label>
                                            <textarea class="form-control" name="resIssn" rows="3" ></textarea>
                                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row["resVol"];?></td>
                                                <td><?php echo $row["resIssue"];?></td>
