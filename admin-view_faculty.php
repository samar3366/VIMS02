...
<head>
    ...
    <title>Admin Portal|View Faculty</title>
    <!-- Bootstrap Core CSS -->
    ...
    <script type="text/javascript">
        ...
        history.replaceState("", "", "admin-view_faculty.php");
        }
    </script>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin-view_faculty.php">View Details</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Faculty Data Table</h4>
                                <h6 class="card-subtitle">Faculty Basic Details &amp; provided link to his/her Profile(wthin FID).</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php $facJntuId=$row["facJntuId"];echo "<a href='admin-faculty-profile.php?facJntuId=".$facJntuId."'>"; echo $facJntuId."</a>";?></td>
                                                <td><?php echo $row["facName"];?></td>
                                                <td><?php echo $row["facDesig"];?></td>
                                                <td><?php echo $row["facDept"];?></td>
